...
public class PlayerBoat2 : MonoBehaviour
{
    ...
    [Header("GameObject Saat Kapasitas Maksimum")]
    public GameObject[] objectsToEnableOnFullTrash;
    ...
    public void CollectTrash(int amount)
    {
        ...
        {
            foreach (GameObject obj in objectsToEnableOnFullTrash)
            {
                if (obj != null)
                    obj.SetActive(true);
            }
